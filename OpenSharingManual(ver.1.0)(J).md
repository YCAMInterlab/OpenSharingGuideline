...
ガイドライン1.0を、ガイドライン2.0と整合するように調整し、必要に応じて省略・2.0へのリンクを添え、6.章に追記する。
図の修正! ガイドライン>マニュアル、オープン化プロセスのマニュアル
...
##1.マニュアルの構成
このマニュアルは5つの章で構成されています。  
まず、事前にオープン化の実施のチェックリストを検討し、この要件を満たすようなら、オープン化の基本マニュアルを参照しつつ制作及びオープン化を実施します。  
ライセンス設定のマニュアルと公開ウェブサイト構成のマニュアルは、基本マニュアルに示された事柄ついてより具体的に示したものです。これらは、基本マニュアルの補足として用いることを想定しています。    
ライセンス設定のマニュアルは、実施主体もしくはプロジェクトごとに、経営方針・プロジェクトの目的にあわせて各実施主体が作成することが前提ですが、ここでは参考例として、YCAMのものを示しています。  
さらに、オープン化プロセスのマニュアルでは、オープン化に必要な設定や作業について、クリエイションのフェーズごとに示しています。  
...
####3.1 オープン化の基本マニュアル (ソフトウェア・ハードウェア)

オープン化で必要な設定や作業を、フェーズ(プリプロダクション、ポストプロダクション)ごとにまとめ、それぞれの目標を示しています。それぞれのオープン化の要素をそれぞれの目標に合うよう調整します。クリエイションに関わるメンバーとオープン化に関するコンセンサスを取り("同意を取ること")、ユーザが参加しやすい環境を作り("参加しやすくする")、オープン化を適切に行います("適切なオープン化を")。  
...
ガイドラインに示されたライセンスを標準的に使用します。プロジェクトの目的、コンセプトに合わせ、必要に応じて他のライセンスの利用を検討します。  
...
プロジェクトの成果をオープン化するプロセスは、他の制作のプロセスと一体不可分なものです。制作プロセス(研究・開発プロセス)のフェーズは大きく3つに分けることができます(プリプロダクション-プロダクション-ポストプロダクション)。このオープン化プロセスのガイドラインもそれぞれのフェーズに対応した、3つのパートで構成されています。  
...
#####6.1.1 why: オープン化の目的 / なぜオープン化するのか
...
#####6.1.2 what: オープン化の対象 / 何をオープン化するのか
...
#####6.1.3 whom: オープン化の相手 / 誰にオープン化するのか  
...
#####6.1.4 who: オープン化の担当者 / 誰がオープン化を担当するのか
...
#####6.1.5 where: 公開ウェブサイト / どこでオープン化するのか
...
>point  
>プロジェクトの性質やオープン化の対象によってウェブサイトの構成は異なります。"ウェブサイト構成のガイドライン"を参照ください。    
...
#####6.1.7 how: オープン化の方法 / どうやってオープン化するのか
...
######6.1.7.3 オープン化を伴うクリエイションの系のデザイン  
